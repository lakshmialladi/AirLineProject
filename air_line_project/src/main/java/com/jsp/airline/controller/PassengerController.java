...
@RestController
@RequestMapping("/airlineproject/passenger")
public class PassengerController 
{
	...
	public ResponseEntity<Long> registerPassenger(@RequestBody PassengerDTO passengerDTO, @PathVariable("bookingInfoId") int bookingInfoId, @PathVariable("checkinId") int checkinId)
	{
	...
	public ResponseEntity<BookingInfoDTO> findBookById(@PathVariable("bookingId") int id)
	{
