...
public class PassengerServiceImp implements PassengerService
{
	...
	public long addBookingInfo(BookingInfoDTO bookingInfoDto) 
	{
		BookingInfo bookingInfo = bookingInfoRepository.save(BookingInfo
												   .builder().destination(bookingInfoDto.getDestination())
	...
	@Override
	public long registerPassenger(PassengerDTO passengerDTO, int bookingInfoId, int checkinId)
	{
	...
	@Override
	public BookingInfoDTO bookingDetailsById(int bookingId) 
	{
